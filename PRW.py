...
class PRW_Data_Opvrager:
    ...
    def get_data(self):
        ...
        df_pbStats_pbs['Onderkant Filter'].values = df_pbs['HOOGTE_MAAIVELD'].values - df_pbs['LENGTE_BUIS'].values
        df_pbStats_pbs['Bovenkant Filter'].values = df_pbs['HOOGTE_MAAIVELD'].values - df_pbs['LENGTE_BUIS'].values + df_pbs['BOVENKANT_FILTER'].values
