...
class PRW_Data_Opvrager:
    ...
    def get_data(self):
        ...
        df_pbStats_pbs['Onderkant Filter'] = df_pbs['HOOGTE_MAAIVELD'] - df_pbs['LENGTE_BUIS'].values
        df_pbStats_pbs['Bovenkant Filter'] = df_pbs['HOOGTE_MAAIVELD'] - df_pbs['LENGTE_BUIS'].values + df_pbs['BOVENKANT_FILTER'].values
